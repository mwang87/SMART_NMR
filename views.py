...
def classic():
    ...
    projector_json_url = "https://{}/embedding_json_classic_global".format(os.getenv("VIRTUAL_HOST"))
...
def resultclassic():
    ...
    projector_json_url = "https://{}/embedding_json_classic/{}".format(os.getenv("VIRTUAL_HOST"), task_id)
    projector_json_url = urllib.parse.quote(projector_json_url)
...
def result():
    ...
    projector_json_url = "https://{}/embedding_json/{}".format(os.getenv("VIRTUAL_HOST"), task_id)
    projector_json_url = urllib.parse.quote(projector_json_url)
...
def embedding_json_classic(task_id):
    ...
    SERVER_URL = "https://{}".format(os.getenv("VIRTUAL_HOST"))
